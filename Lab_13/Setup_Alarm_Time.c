    ...
    {   
         if (check_for_button_input() == 1)
         {
             if (found >= Prev && found <= EQ)
             {
                ...
                if (found == Play_Pause) Do_Save_New_Alarm_Time();// add code here to check if 'Play/Pause' then use Do_Save_New_Time();                
...
void Increase_Alarm_Time()
{
            switch (Select_Alarm_Field)             // Increment the proper field
            {
                ...
                case 1:
                    ...
                    setup_alarm_minute++;
                    if (setup_alarm_minute == 60) setup_alarm_minute = 0; // maybe to 59
                    break;
...
void Update_Setup_Alarm_Time_Screen(void)
{
    ...
    setup_alarm_time[1]  = (setup_alarm_hour%10)  + '0';// add code here 
    setup_alarm_time[3]  = (setup_alarm_minute/10)  + '0';// add code here
    setup_alarm_time[4]  = (setup_alarm_minute%10)  + '0';// add code here
    setup_alarm_time[6]  = (setup_alarm_second/10)  + '0';// add code here
    setup_alarm_time[7]  = (setup_alarm_second%10)  + '0';// add code here 
