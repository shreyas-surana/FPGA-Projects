...
void Update_Screen(void)
{
    ...
    Heater_Set_Temp_Txt[0] = (heater_set_temp/100) + '0'; // add code
    Heater_Set_Temp_Txt[1] = (heater_set_temp%100) / 10 + '0'; // add code 
    Heater_Set_Temp_Txt[2] = (heater_set_temp%10) + '0'; // add code 
    ...
    float volt2 = volt *10;
    float volt3 = volt *100;
    Volt_Txt[2] = (int)volt2%10 + '0'; // add code 
    Volt_Txt[3] = (int)volt3%10 + '0'; // add code not sure if this is same 
